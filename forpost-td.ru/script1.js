function Ant(crslId) {
    ...
    this.leftArrow = this.crslRoot.querySelector('div.ant-carousel-arrow-left1');
    this.rightArrow = this.crslRoot.querySelector('div.ant-carousel-arrow-right1');
...
Ant.defaults = {
    ...
    interval: 50000, // Интервал между прокруткой элементов (мс)
    speed: 450, // Скорость анимации (мс)
